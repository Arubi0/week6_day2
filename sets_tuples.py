...
# #you cannot accesselements in a set index because sets are unordered
# #instead you can convert the set a list and access element by index

# list1 = list(set1)
# print(list1[0]) #output: 1

# #we use sets when we want to store unique elemejnts
...
#queue the videos(2) alliteration
